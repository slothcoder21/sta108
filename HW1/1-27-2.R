...
predicted_mass <- predict(linear_model, newdata = new_data)
cat("Point estimate of mean muscle mass at age 60: ", predicted_mass)

#Point estimate of mean muscle mass at age 60:  84.94683